...
<?php
   ...
   $query = "SELECT * FROM lawyer WHERE lawyerid = '$lawyerid'";
//    error_reporting(0);
...
<section>
  ...
  <!-- <h1>Update</h1> -->
    ...
    <form ction="lawyerUpdate.php?lawyerid=<?php echo $lawyerid; ?>" class="form-signup" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" value="<?php echo $result['licenseNo'] ?>" name="licenseNo"  id="formInput" class="form-control my-3" placeholder="licenseNo" required>
    <input type="text" value="<?php echo $result['qualification'] ?>" name="qualification" id="formInput" class="form-control my-3" placeholder="qualification" required>
    <input type="text" value="<?php echo $result['experience'] ?>" name="experience" id="formInput" class="form-control my-3" placeholder="experience" required>
    <div class="text-center">
    <button type="submit" value="Update" class="btn btn-primary" name="update" id="formButn1" required>lawyerUpdate</button> 
    </div>
    </form> 
    </div>
    </div>
...
if(isset($_POST['update'])) {
    ...
    $sql= "UPDATE lawyer set lawyerid = '$lawyerid',licenseNo='$licenseNo',qualification ='$qualification'
    ,experience='$experience' WHERE  lawyerid='$lawyerid'";
    // Perform the query
