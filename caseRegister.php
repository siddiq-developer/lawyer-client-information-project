...
<section>
  ...
  <!-- <h1 class="logAdm">Admin</h1> -->
</div>
</div>
    <form ction="case.php" class="form-signup" method="POST" enctype="multipart/form-data">
    <input type="text" name="caseid" id="formInput" class="form-control" placeholder="caseid">
    <input type="text" name="lawyerid" id="formInput" class="form-control my-3" placeholder="lawyerid">
    <input type="text" name="case_description" id="formInput" class="form-control my-3" placeholder="case_description">
    <input type="text" name="evidence" id="formInput" class="form-control my-3" placeholder="evidence">
    <div class="text-center">
    <button type="submit" value="register" class="btn btn-primary" name="register" id="formButn">Case Add</button> 
    </div>
    </form> 
    </div>
    </div>
...
if(isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO cases (caseid,lawyerid,case_description, evidence) 
    VALUES ('$caseid','$lawyerid','$case_description', '$evidence')";
